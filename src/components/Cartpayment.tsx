...
//   return (
//     <div>
//       <span><p className="text-sm"> Your order qualifies for FREE Shipping by Choosing this option at
//           checkout. See details....
//         </p></span>
//         <p className="flex items-center justify-between px-2 font-semibold">Total:{" "}<span>
//         <FormattedPrice amount={totalAmount} />
//         </span>
//         </p>
//         {
//           userInfo ?(<div className="flex flex-col items-center">
//           <button onClick={handleCheckout} className="w-full h-10 text-sm font-semibold bg-amazon_blue bg-opacity-50 text-white rounded-lg ">>Proceed to Checkout</button>
//           {/* <button className="w-full h-10 text-sm font-semibold bg-amazon_blue bg-opacity-50 text-white rounded-lg ">>Proceed to Checkout</button> */}
          
//         </div>):(<div className="flex flex-col items-center">
//   <button className="w-full h-10 text-sm font-semibold bg-amazon_blue bg-opacity-50 text-white rounded-lg cursor-not-allowed">Proceed to Checkout</button>
